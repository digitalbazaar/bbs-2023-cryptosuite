...
export function parseBaseProofValue({proof} = {}) {
  try {
    ...
    const params = {bbsSignature, hmacKey, mandatoryPointers};
...
export function serializeBaseProofValue({
  bbsSignature, hmacKey, mandatoryPointers
} = {}) {
  _validateBaseProofParams({bbsSignature, hmacKey, mandatoryPointers});
...
function _validateBaseProofParams({bbsSignature, hmacKey, mandatoryPointers}) {
...
function _validateBaseVerifyDataParams({proofHash, publicKey, mandatoryHash}) {
